...
public class DataRestClient<Value extends Any> extends SimpleDataSource<Object, Value> implements AutoCloseable {
    ...
    String encodedQueryParams(Property... params) {
    ...
    public Object add(Value value) throws RuntimeException {
        ...
        try {
            ...
            Value created = (Value) MessageParser.unmarshal(anyClassType, result);
    ...
    public Value read(Object key) throws RuntimeException {
        ...
        try {
            ...
            Value value = (Value) MessageParser.unmarshal(anyClassType, getResult);
            super.put(key, value);
            return value;
        } catch (Exception e) {
            throw new RuntimeException(e);
